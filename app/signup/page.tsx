...
import { ArrowLeft, Lock, Phone, User, MapPin, ArrowRight, UserCheck } from "lucide-react"
...
export default function SignupPage() {
  ...
  const { registerCustomer, isCustomerAuthenticated, currentCustomer, logoutCustomer } = useAuth()
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="address"
                      type="text"
                      placeholder="Village Chak, District"
                      disabled={loading}
                      className="pl-12 h-12 rounded-xl"
                      value={address}
                      onChange={(e) => {
